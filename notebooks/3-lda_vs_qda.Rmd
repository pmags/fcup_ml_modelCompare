...
l_w_1 <- list(
  ...
  px_0 <- dmvnorm(c(x1,x2), mean = l_mu_1[[1]], sigma = l_cvm_1[[1]]) * 0.65 
  px_1 <- dmvnorm(c(x1,x2), mean = l_mu_1[[2]], sigma = l_cvm_1[[2]]) * 0.35
...
grid.arrange(
  ...
  metrics_ds1_QDA$cf_plot ,
  metrics_ds2_LDA$cf_plot ,
  metrics_ds2_QDA$cf_plot ,
  nrow = 2,
...
grid.arrange(
  ...
  metrics_ds1_QDA$roc_curve ,
  metrics_ds2_LDA$roc_curve ,
  metrics_ds2_QDA$roc_curve ,
  nrow = 2,
  top = "ROC curves"
)

  metrics_ds1_LDA$auc_roc
  metrics_ds1_QDA$auc_roc
  metrics_ds2_LDA$auc_roc
  metrics_ds2_QDA$auc_roc
 metrics_ds1_LDA$acc
  metrics_ds1_QDA$acc
  metrics_ds2_LDA$acc
  metrics_ds2_QDA$acc
